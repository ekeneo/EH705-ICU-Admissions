 ...
 * Due to the increased ratio in the population ofmale to female, the ratio of the number of patients who lived is found almost directly proportional between male and female.
 ...
 * In the case of the Vital status by Cancer graph, there are more patients without a present case of Cancer, however there are als more patients who died and do not have a present case of Cancer.
 ...
 * For the Vital Status by Renal, there are more patients without history of chronic Renal failure and most of then lived however, it is also observed that there seems to be an equal proportion in Status of patients who had an history with chronic Renal failure.
 ...
 * For the Vital Status by Type, there are more patients with emergency ICU admission and those also expereince more cases of death than the elective ICU admissions.  
...
__H0__: the variances for Age is the same across all levels of consciousness  
__Ha__: the variances are different
...
__H0__: variances are homogenous   
...
Furthermore, most admitted patients had no chronic renal failure, no previous admissions to the ICU, fracture, CPR or cancer when admitted. Also most admitted patients had PO2 above or equal to 60, blood pH above or equal to 7.25, PCO2 below or equal to 45, and creatinine below or equal to 2. Due to the large difference between groups some of these variables were not further explored, and the focus of exploratory data analysis and understanding of distribution was on variables where values might have been prior to admission. These might aid clinicians who work in the ICU in understanding the likelihood of survival for individuals who are admitted before lab work has been ordered.      
...
### Associations with Numeric Attributes     
...
## Differences in Proportions for Categorical Attributes         
...
Lastly, we also followed up our results with a Goodman Kruskall’s Lambda analysis, and found that while the relationship between the predictors we focused on and the response variable was not 0 as it was approximately 0.25, it also was not 1 therefore denoting a somewhat weak relationship.       
...
Our final model deduced was 
Status=(1.118927e-03)+(6.130498e+00) Age.binnedGroup4+(1.025275e+01)Age.binnedGroup5+(3.130311e-01)ServiceSurgical+(2.183970e+01)CancerYes+(6.624874e+00)PreviousYes+(3.463936e+01)ConsciousnessComa+(2.575717e+01)TypeEmergency       

## Possibility of survival based on classification and regression trees         
...
## Comments regarding our dataset & analysis       

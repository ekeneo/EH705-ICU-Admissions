...
Lambda(ICU$Age.binned, ICU$Status, direction=c("symmetric", "row", "column"), conf.level = 0.95)
Lambda(ICU$Service,ICU$Status, direction=c("symmetric", "row", "column"), conf.level=0.95)
Lambda(ICU$Cancer, ICU$Status, direction=c("symmetric", "row", "column"), conf.level=0.95)
Lambda(ICU$Previous, ICU$Status, direction=c("symmetric", "row", "column"), conf.level=0.95)
Lambda(ICU$Type, ICU$Status,direction=c("symmetric", "row", "column"), conf.level = 0.95)
Lambda(ICU$Systolic.grouped, ICU$Status,direction=c("symmetric", "row", "column"), conf.level = 0.95)
Lambda(ICU$HeartRate.grouped, ICU$Status,direction=c("symmetric", "row", "column"), conf.level = 0.95)
Lambda(ICU$Consciousness, ICU$Status,direction=c("symmetric", "row", "column"), conf.level = 0.95)
Lambda(ICU$CPR, ICU$Status,direction=c("symmetric", "row", "column"), conf.level = 0.95)
Lambda(ICU$Infection, ICU$Status,direction=c("symmetric", "row", "column"), conf.level = 0.95)
Lambda(ICU$Sex, ICU$Status,direction=c("symmetric", "row", "column"), conf.level = 0.95)
Lambda(ICU$Renal, ICU$Status,direction=c("symmetric", "row", "column"), conf.level = 0.95)
```
## Logistic Regression 
